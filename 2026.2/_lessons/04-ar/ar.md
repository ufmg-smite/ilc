...
[README]({{ site.baseurl }}{% link _lessons/04-ar/cvc5-c/README.md %}),
junto com os três programas prontos para compilar:
[`sat.c`]({{ site.baseurl }}{% link _lessons/04-ar/cvc5-c/sat.c %}),
[`equivalencia.c`]({{ site.baseurl }}{% link _lessons/04-ar/cvc5-c/equivalencia.c %}),
[`n-rainhas.c`]({{ site.baseurl }}{% link _lessons/04-ar/cvc5-c/n-rainhas.c %}) e um
[`Makefile`]({{ site.baseurl }}{% link _lessons/04-ar/cvc5-c/Makefile %}).
...
**Em C**, usando o arquivo [`sat.c`]({{ site.baseurl }}{% link _lessons/04-ar/cvc5-c/sat.c %}):
...
**Em C**, usando o arquivo [`equivalencia.c`]({{ site.baseurl }}{% link _lessons/04-ar/cvc5-c/equivalencia.c %}):
...
**Em C**, usando o arquivo [`n-rainhas.c`]({{ site.baseurl }}{% link _lessons/04-ar/cvc5-c/n-rainhas.c %}):
...
`∧`, `∨`, `¬`, `→` que estudamos em [lógica proposicional]({{ site.baseurl }}{% link _lessons/01-prop-logic/prop-logic.md %}) —, mas no lugar das variáveis
...
1. **Comece pelos exemplos acima.** Reescreva-os, mude as fórmulas, veja
